...
const auswer_btn = document.querySelector('#answer_btn')

console.log(num_input, result_type, result_val, auswer_btn)
console.log(num_input.value) //실시간 input값 추적되지 않으므로 결과값 표사안됨

answer_btn.addEventListener('click',function(){
    console.log(num_input.value) //버튼 추적 기능확인
    console.log(typeof num_input.value) //str -> num
    //num_input의 값을 숫자로 변환하느 저장 변수
