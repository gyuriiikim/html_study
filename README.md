...
<h2>23.03.07 - CSS - kakao </h2>
  <dl>
    ...
    <dt>position:pixed</dt>
    <dd>g]헤더고정긴능 / 넓이값이 바뀌기 때문에 넓이를 100%로 해줘야한다.</dd><br>
    <dd>비디오 선택자에서는 넓이를 %로 해주어야하고 비디오 선택자의 부모에게는 overflow를 해줘야한다</dd>
    <dt>transform:translate</dt>
    <dd>중심축의 x축 y축을 바꿔주는 기능이다.-> 정해진 옵션이기때문에 그대로 외워두기!!</dd>
    <dd>작성한 기능들 중 같은 값 같은것들은 선택자에서 한번에 정리해서 적어주는 것이 좋다</dd>
  </dl>
<hr>
<h2>23.03.08 - CSS - 서울특별시 </h2>
<dl>
  <dt>스트라이트</dt>
...
<h2>23.03.13 - CSS - 반응형미디어쿼리 </h2>
<dl>
  <dt>가변 그리드 공식</dt>
  <dd>만들박스 넓이값 나누기 전체넓이 값 곱하기 100 / ex) 500나누기900 x100</dd>
  <dt>미디어쿼리</dt>
  <dd>미디어 쿼리란 단말기의 유형(출력물 또는 화면이 어떤특성이나 수치에 따라 웹 사이트나 앱의 스타일을 수정할때 유용하다.</dd>
  <dd>-> 사용자 화면이 보는 것에 따라 달라지는 것을 말한다.</dd>
  <dd>min-width : 최소 제한너비를 설정 / max-width : 최대 제한 너비를 설정</dd>
  <dd>크고 작은 순서가 일정하게 이루워져야한다.</dd>
  <dt>GIT</dt>
  <dd><a href="https://webty.tistory.com/213">블로그참고</a></dd>
</dl>
<h2>23.03.20 - js - 자바스크립트&상수변수 </h2>
<dl>
  <dt>스크립트를 작성하려면?</dt>
  <dd>목표 설정하기</dd>
  <dd>흐름도 만들기(알고리즘이라고도 한다)</dd>
  <dd>각 단계를 코드로 표현하기</dd>
  <dt>자바스트립트?</dt>
  <dd>객체지향프로그래밍 언어입니다 / 객체지향은 웹에서 제어하는 요소를 객체지향이라고 한다</dd>
  <dd></dd>
  <dd></dd>
  <dd></dd>
  <dt>바닐라 자바스크립트</dt>
  <dd>순수 js를 이용하려는 것을 바닐라js라고한다</dd>
  <dt>ECMA Script</dt>
  <dd></dd>
  <dt></dt>
  <dd></dd>
